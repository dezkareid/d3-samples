var dataSet = [
  ...
  [1,"Aguascalientes",1995,10.0],
  [2,"Baja California",1995,5.0],
  [3,"Baja California Sur",1995,6.0],
  [4,"Campeche",1995,1.0],
  [5,"Chiapas",1995,15.0],
  ...
  [1,"Aguascalientes",1997,5.0],
  [2,"Baja California",1997,100.0],
  [3,"Baja California Sur",1997,7.0],
  [4,"Campeche",1997,2.0],
  [5,"Chiapas",1997,16.0],
  [6,"Chihuahua",1997,33.0],
  [7,"Coahuila de Zaragoza",1997,3.0],
  [8,"Colima",1997,2.0],
  [9,"Distrito Federal",1997,43.0],
  [10,"Durango",1997,39.0],
  [11,"Guanajuato",1997,57.0],
  [12,"Guerrero",1997,24.0],
  [13,"Hidalgo",1997,7.0],
  [14,"Jalisco",1997,16.0]
];
